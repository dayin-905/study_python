...
#  ✓  Edit quests/05.py: frist = 5   # 오타 => first = 5                 │▄
# │                                                                       │█
# │ 1 - frist = 5   # 오타                                                │█
# │ 1 + first = 5                                                         │█
# │ 2                                                                     │█
# │ 3   while first > 0:                                                  │█
# │ 4       print(f"while 값 : {first}") 
...
# │ ✓  Edit quests/05.py: while first > 0:... => while first > 0:...      │ 
# │                                                                       │ 
# │ 1   first = 5                                                         │ 
# │ 2                                                                     │ 
# │ 3   while first > 0:                                                  │ 
# │ 4 - print(f"while 값 : {first}")  # 들여쓰기 문제                     │ 
# │ 4 +     print(f"while 값 : {first}")                                  │█
# │ 5       first = first - 1   
...
# ✅ 문제 3 — 논리적 오류(조건문) 찾기
# 다음 프로그램은 first가 3일 때 break가 실행돼야 하는데,
...
#  3   while first > 0:                                                  │ 
# │ 4       print(f"while 값 : {first}")                                  │ 
# │ 5 -     if first < 3:     # 실제로는 first == 3 에서 break해야 하는   │ 
# │   문제 조건                                                           │ 
# │ 5 +     if first == 3:     # 실제로는 first == 3 에서 break해야 하는  │ 
# │   문제 조건                                                           │ 
# │ 6           print("break 실행")                                       │ 
